...
local function test_straightPathOnGrass()
    ...
    local path  = pathfinding.findPath(tiles, tileIndex(1, 1), tileIndex(4, 1))
...
local function test_diagonalShortcut()
    local tiles = makeGrassGrid()
    local path  = pathfinding.findPath(tiles, tileIndex(1, 1), tileIndex(3, 3))
...
local function test_pathAroundWater()
    ...
    local path = pathfinding.findPath(tiles, tileIndex(1, 1), tileIndex(5, 1))
...
local function test_noPathToIsolatedTile()
    ...
    local path = pathfinding.findPath(tiles, tileIndex(1, 1), tileIndex(5, 5))
...
local function test_adjacentToRect()
    local tiles = makeGrassGrid()
    local path  = pathfinding.findPathAdjacentToRect(tiles, tileIndex(1, 1), 5, 5, 1, 1)
...
local function test_diagonalBlockedByImpassable()
    ...
    local path = pathfinding.findPath(tiles, tileIndex(1, 1), tileIndex(2, 2))
...
local function test_trivialPath()
    local tiles = makeGrassGrid()
    local path  = pathfinding.findPath(tiles, tileIndex(3, 3), tileIndex(3, 3))
